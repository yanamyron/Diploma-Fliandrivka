...
const Masterclass1 = () => {
  const [formData, setFormData] = useState({
    ...
    emailvisitor: "",
    tgvisitor: "",
    activity: "carving", // Різьблення як дефолтний тип заняття
    formofactivity: "group", // Групове заняття як дефолтний тип
    howcontact: "",
    date: "",
  });
    ...
    <>
      <FormBlock>
        ...
        <Form onSubmit={onSubmitHandler}>
          ...
          <TitleForm>Тип: Різьблення</TitleForm>
          <TitleForm>Дата: 14 червня</TitleForm>
            ...
            <div>
              <div>
                <input
                  ...
                  value="group"
                  onChange={onChangeHandler}
                  checked // Встановлюємо групове заняття як дефолтне і вибране
                />
                <label htmlFor="group">Різьблення</label>
              </div>
            </div>
          </div>
