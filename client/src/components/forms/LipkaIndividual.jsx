...
const LipkaIndividual = () => {
  const [formData, setFormData] = useState({
    visitorname: "",
    phonenumberv: "",
    emailvisitor: "",
    tgvisitor: "",
    activity: "lipka", // Setting 'activity' to 'lipka' as default
    formofactivity: "individual", // Setting 'formofactivity' to 'individual' as default
    howcontact: "",
    date: "",
  });
  ...
  const onChangeHandler = (event) => {
    ...
    if (event.target.name === "phonenumberv") {
      // Validate phone number here
      if (!/^\d{0,10}$/.test(event.target.value)) {
        // Assuming you want a maximum of 10 digits for the phone number
...
export default LipkaIndividual;
