...
const LipkaGroup = () => {
  const [formData, setFormData] = useState({
    ...
    emailvisitor: "",
    tgvisitor: "",
    activity: "lipka", // Ліпка вибрано за замовчуванням
    formofactivity: "group", // Групове вибрано за замовчуванням
    howcontact: "",
    date: "",
  });
              ...
              <div>
                ...
                <div>
                  <input
                    ...
                    value="lipka"
                    onChange={onChangeHandler}
                    checked={formData.activity === "lipka"} // Ліпка вибрана за замовчуванням
              ...
              <div>
                <div>
                  <input
                    ...
                    value="group"
                    onChange={onChangeHandler}
                    checked={formData.formofactivity === "group"} // Групове вибране за замовчуванням
                    readOnly // Тільки для читання
                  />
              ...
              <div>
                <div>
                  <input
                    ...
                    value="split"
                    onChange={onChangeHandler}
                    disabled // Вимкнене парне заняття
                  />
              ...
              <div>
                <div>
                  <input
                    ...
                    value="individual"
                    onChange={onChangeHandler}
                    disabled // Вимкнене індивідуальне заняття
                  />
              ...
              <div>
                <div>
                  <input
                    ...
                    onChange={onChangeHandler}
                  />
                  <label htmlFor="emailmassag">Лист на електронну пошту</label>
                </div>
              </div>
              <div>
                <div>
